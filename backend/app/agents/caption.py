"""CaptionAgent extracting word-level timestamps and building animated ASS subtitles."""
...
class CaptionAgent(BaseAgent):
    ...
    def build_ass_subtitles(
        ...
        # ASS Header with 1080x1920 resolution & safe vertical margins
...
"""
        ...
        # Iterate over segments and chunk into short 2-3 word pop-ups
        for seg in segments:
            words = seg.words
            if not words:
            ...
            for i in range(0, len(words), chunk_size):
                ...
                # Format words with uppercase bold styling
    ...
    async def generate_captions(
        ...
        """Transcribe audio with Whisper and write synchronized ASS subtitle file."""
